...
const SaveBtn = ({ data }) => {
  ...
  return (
    <button
      className="border-0 bg-none cursor-pointer outline-0"
...
const Saved = () => {
  ...
  return (
    <section className="relative flex flex-col mt-16 mb-24 w-[80%] h-full">
      <div className="border-gray-100 py-8 border rounded w-full min-h-[60vh]">
        {savedData ? (
              ...
              {savedData &&
                savedData.map((data) => {
                  return (
                    <tr
                      key={data.id}
                      className="border-gray-100 hover:bg-gray-200 border-b text-base text-center"
                    >
                      <td className="flex items-center py-4 uppercase">
                        ...
                        <img
                          src={data.image}
                          alt={data.id}
                          className="mx-1.5 w-[1.2rem] h-[1.2rem]"
                        />
          ...
          <h1 className="flex justify-center items-center min-h-[60vh] text-cyan text-lg">
